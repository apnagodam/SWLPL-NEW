...
class Firstqualitylist extends ConsumerWidget {
  Firstqualitylist({super.key});
    ...
    return Scaffold(
      body: Platform.isIOS
          ? CupertinoPageScaffold(
              ...
              child: firstQualityReportLayout(context, ref))
          : Scaffold(
              appBar: AppBar(
                title: const Text('First Quality Report'),
              ),
              body: firstQualityReportLayout(context, ref),
            ),
    );
  }

  firstQualityReportLayout(BuildContext context, WidgetRef ref) => ListView(
        children: [
          ref.watch(firstQualityListProvider).when(
              data: (data) {
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final differenceInMinutes = dateTimeNow
                                  ...
                                  60;
                              var currentInStatus =
                                  distinctList[index]?.fKPCaseId != null
                                      ? "Done"
                                      : "First Kanta Parchi Pending";
                                ...
                                child: Padding(
                                  ...
                                  child: ColumnSuper(
                                      ...
                                      children: [
                                                ...
                                                builder: (bottomsheetContext) =>
                                                    ElevarmDraggableBottomSheet(
                                                        ...
                                                        children: [
                                                          ...
                                                          ElevarmDivider(),
                                                          Text(
                                                            'Packaging Type: ${distinctList[index]?.packagingType}',
                                                            textAlign:
                                                                TextAlign.left,
                                                            style:
                                                                ElevarmFontFamilies
                                                          ...
                                                          ElevarmThumbnailList(
                                                            imageUrls: [
                                                              "${ref.watch(dioProvider).options.baseUrl}/resources/assets/upload/quality_report/${distinctList[index]?.imge}",
                                                            ],
                                                            size: 62.0,
                                                            onTap: (context,
                                                                index) {},
                                        ...
                                        // distinctList[index]?.qRCaseId == null && distinctList[index]?.fKPCaseId!=null
                                        //     ? AnimatedButton(
                                        //         height: 50,
                                        //         color: primaryColorDark,
                                        //         width: MediaQuery.of(context)
