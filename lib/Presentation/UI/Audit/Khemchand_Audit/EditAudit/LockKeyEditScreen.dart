...
class LockKeyAuditEditScreen extends ConsumerStatefulWidget {
  const LockKeyAuditEditScreen(
  ...
  @override
  ConsumerState<LockKeyAuditEditScreen> createState() =>
...
class _LockAndKeyScreenState extends ConsumerState<LockKeyAuditEditScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text('Lock & Key Audit Edit'),
          foregroundColor: Colors.white,
        ),
        body: ref.watch(lockKeyAuditEditProvider(Id: widget.auditid)).when(
            data: (LockKeyEdit) => Padding(
