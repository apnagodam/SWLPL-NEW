...
import '../../../Data/Models/SecondKantaparchiListModel.dart';
import '../../../Data/SharedPrefs/SharedUtility.dart';
import '../../Constants/ColorConstant.dart';
import '../../Widgets/widgets.dart';

class Secondkantaparchilist extends ConsumerWidget {
  Secondkantaparchilist({super.key, required this.inOut});
    ...
    return Scaffold(
      body: Platform.isIOS
          ? CupertinoPageScaffold(
              ...
              child: secondKantaparchiList(context, ref))
          : Scaffold(
              appBar: AppBar(
                title: const Text('Second Kanta Parchi'),
              ),
              body: secondKantaparchiList(context, ref),
            ),
    );
  }

  secondKantaparchiList(BuildContext context, WidgetRef ref) => ListView(
        children: [
          ref.watch(secondKantaparchiListProvider(inOut: inOut)).when(
              data: (data) {
                    ...
                    : distinctList.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              var currentInStatus =
                                  distinctList[index]?.fQIvrCaseId != null
                                      ? "Done"
                                      : "First Quality IVR Pending";
                                                    ...
                                                    ElevarmDraggableBottomSheet(
                                                        ...
                                                        children: [
                                                          ...
                                                          ElevarmThumbnailList(
                                                            imageUrls: [
                                                              "${ref.watch(dioProvider).options.baseUrl}/resources/assets/upload/second_kanta_parchi/${distinctList[index]?.file}",
                                                              "${ref.watch(dioProvider).options.baseUrl}/resources/assets/upload/second_kanta_parchi/${distinctList[index]?.file2}",
                                                            ],
                                                            size: 62.0,
                                                            onTap: (context,
                                                                index) {},
