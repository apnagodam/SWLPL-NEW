                                  ...
                                  Row(
                                    children: [
                                      Expanded(
                                        ...
                                        onPressed: () {
                                          DateTime daTATimeCreatedAt =
                                              DateTime.parse(
                                                  "${displedgeList.data?[index].createdAt ?? ""}");
                                          daTATimeCreatedAt.formatDate();
                                              ...
                                              builder: (bottomsheetContext) =>
                                                  ElevarmDraggableBottomSheet(
                                                      ...
                                                      children: [
                                                        ...
                                                        ElevarmDivider(),
                                                        Text(
                                                          'weight: ${displedgeList.data?[index].netWeight ?? ''} (Qtl.)',
                                                          textAlign:
                                                              TextAlign.left,
                                                          style:
                                                              ElevarmFontFamilies
                                                        ...
                                                        ElevarmDivider(),
                                                        Text(
                                                          'Created Date:${daTATimeCreatedAt} ',
                                                          textAlign:
                                                              TextAlign.left,
                                                          style:
                                                              ElevarmFontFamilies
