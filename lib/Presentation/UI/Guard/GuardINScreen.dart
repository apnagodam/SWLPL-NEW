...
class Guardinscreen extends ConsumerStatefulWidget {
...
class _GuardinscreenState extends ConsumerState<Guardinscreen> {
                                                                    ...
                                                                    TapGestureRecognizer()
                                                                      ..onTap =
                                                                        ...
                                                                        ImagePicker()
                                                                          ...
                                                                          if (file !=
                                                                              null) {
                                                                            createStampedImage(File(file.path).readAsBytesSync(), ref).then((value) async {
                                                                            if(value!=null){
