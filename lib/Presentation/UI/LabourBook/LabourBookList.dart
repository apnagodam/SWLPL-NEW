...
import '../../../Data/Models/LabourBookListModel.dart';
import '../../../Data/SharedPrefs/SharedUtility.dart';
import '../../Constants/ColorConstant.dart';
import '../../Widgets/widgets.dart';

class Labourbooklist extends ConsumerWidget {
  Labourbooklist({super.key, required this.inOut});
    ...
    return Scaffold(
      body: Platform.isIOS
          ? CupertinoPageScaffold(
              navigationBar: cupertinoAppBar("Labour Book", context),
              child: labourBookLayout(context, ref))
          : Scaffold(
              appBar: AppBar(
                title: const Text('Labour Book'),
              ),
              body: labourBookLayout(context, ref),
            ),
    );
  }

  labourBookLayout(BuildContext context, WidgetRef ref) =>
      RefreshIndicator.adaptive(
          child: ListView(
            children: [
              ref.watch(labourListProvider(inOut: inOut)).when(
                  data: (data) {
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final differenceInMinutes = dateTimeNow
                                  ...
                                  60;
                              var currentInStatus =
                                  distinctList[index]?.tbCaseId != null
                                      ? "Done"
                                      : "Truck Book Pending";
                                                ...
                                                builder: (bottomsheetContext) =>
                                                    ElevarmDraggableBottomSheet(
                                                        ...
                                                        children: [
                                                          ...
                                                          ElevarmDivider(),
                                                          // Text(
                                                          //   'Driver Name: ${distinctList[index]?.}',
                                                          //   textAlign:
                                                          //       TextAlign.left,
                                                          //   style:
                                                          //       ElevarmFontFamilies
                                                          ...
                                                          ElevarmDivider(),
                                                          Text(
                                                            'Labour Type: ${distinctList[index]?.labourContractor}',
                                                            textAlign:
                                                                TextAlign.left,
                                                            style:
                                                                ElevarmFontFamilies
                                                          ...
                                                          ElevarmDivider(),
                                                          Text(
                                                            'Labour Contractor No.: ${distinctList[index]?.contractorNo}',
                                                            textAlign:
                                                                TextAlign.left,
                                                            style:
                                                                ElevarmFontFamilies
