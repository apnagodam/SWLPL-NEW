...
IndexDataModel IndexDataModelFromMap(String str) =>
    IndexDataModel.fromMap(json.decode(str));
...
class IndexDataModel {
  ...
  factory IndexDataModel.fromMap(Map<String, dynamic> json) => IndexDataModel(
        todaysPrice: json["todays_price"] == null
            ? []
            : List<IndexDataModelTodaysPrice>.from(json["todays_price"]!
                .map((x) => IndexDataModelTodaysPrice.fromMap(x))),
        commodites: json["commodites"] == null
            ? []
            : List<Commodit>.from(
                json["commodites"]!.map((x) => Commodit.fromMap(x))),
        testimonials: json["testimonials"] == null
            ? []
            : List<Testimonial>.from(
                json["testimonials"]!.map((x) => Testimonial.fromMap(x))),
        status: json["status"],
        message: json["message"],
      );

  Map<String, dynamic> toMap() => {
        "todays_price": todaysPrice == null
            ? []
            : List<dynamic>.from(todaysPrice!.map((x) => x.toMap())),
        "commodites": commodites == null
            ? []
            : List<dynamic>.from(commodites!.map((x) => x.toMap())),
        "testimonials": testimonials == null
            ? []
            : List<dynamic>.from(testimonials!.map((x) => x.toMap())),
        "status": status,
        "message": message,
      };
}
...
class IndexDataModelTodaysPrice {
  ...
  factory IndexDataModelTodaysPrice.fromMap(Map<String, dynamic> json) =>
      IndexDataModelTodaysPrice(
        id: json["id"],
        wspId: json["wsp_id"],
        ...
        todaysPrice: json["todays_price"] == null
            ? []
            : List<TodaysPriceTodaysPrice>.from(json["todays_price"]!
                .map((x) => TodaysPriceTodaysPrice.fromMap(x))),
      );
...
class TodaysPriceTodaysPrice {
  ...
  factory TodaysPriceTodaysPrice.fromMap(Map<String, dynamic> json) =>
      TodaysPriceTodaysPrice(
        id: json["id"],
        modal: json["modal"],
        max: json["max"],
        ...
        commodity: json["commodity"] == null
            ? null
            : Commodit.fromMap(json["commodity"]),
      );
