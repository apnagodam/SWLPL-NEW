...
//
//     final labourBookListModel = labourBookListModelFromMap(jsonString);

import 'dart:convert';

LabourBookListModel labourBookListModelFromMap(String str) =>
    LabourBookListModel.fromMap(json.decode(str));

String labourBookListModelToMap(LabourBookListModel data) =>
    json.encode(data.toMap());

class LabourBookListModel {
  String? status;
  String? message;
  Data? data;
  ...
  factory LabourBookListModel.fromMap(Map<String, dynamic> json) =>
      LabourBookListModel(
        status: json["status"],
...
class Datum {
  ...
  factory Datum.fromMap(Map<String, dynamic> json) => Datum(
        ...
        contractorNo: json["contractor_no"],
        labourRatePerBags: json["labour_rate_per_bags"],
        tbCaseId: json['tb_caseid'],
        notes: json["notes"],
  ...
  Map<String, dynamic> toMap() => {
        ...
        "contractor_no": contractorNo,
        "labour_rate_per_bags": labourRatePerBags,
        'tb_caseid': tbCaseId,
        "notes": notes,
