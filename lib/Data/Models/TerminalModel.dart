...
TerminalsModel terminalsModelFromMap(String str) => TerminalsModel.fromMap(json.decode(str));
...
class Employee {
  ...
  Map<String, dynamic> toMap() => {
    ...
    "doe": "${doe!.year.toString().padLeft(4, '0')}-${doe!.month.toString().padLeft(2, '0')}-${doe!.day.toString().padLeft(2, '0')}",
