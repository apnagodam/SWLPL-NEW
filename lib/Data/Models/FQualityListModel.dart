...
//
//     final fQualityListModel = fQualityListModelFromMap(jsonString);

import 'dart:convert';

FQualityListModel fQualityListModelFromMap(String str) => FQualityListModel.fromMap(json.decode(str));

String fQualityListModelToMap(FQualityListModel data) => json.encode(data.toMap());

class FQualityListModel {
  String? status;
  String? message;
  Data? data;
  ...
  factory FQualityListModel.fromMap(Map<String, dynamic> json) => FQualityListModel(
    status: json["status"],
...
class Datum {
  ...
  factory Datum.fromMap(Map<String, dynamic> json) => Datum(
    ...
    labourBookCaseId: json["labour_book_case_id"],
  );
  ...
  Map<String, dynamic> toMap() => {
    ...
    "labour_book_case_id": labourBookCaseId,
  };
}
