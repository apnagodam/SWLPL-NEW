...
//
//     final voucherApprovalModel = voucherApprovalModelFromMap(jsonString);

import 'dart:convert';

VoucherApprovalModel voucherApprovalModelFromMap(String str) => VoucherApprovalModel.fromMap(json.decode(str));

String voucherApprovalModelToMap(VoucherApprovalModel data) => json.encode(data.toMap());

class VoucherApprovalModel {
    Data? data;
    String? status;
    String? message;

    VoucherApprovalModel({
        this.data,
        this.status,
        this.message,
    });

    factory VoucherApprovalModel.fromMap(Map<String, dynamic> json) => VoucherApprovalModel(
