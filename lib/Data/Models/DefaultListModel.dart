...
//
//     final defaultListModel = defaultListModelFromMap(jsonString);

import 'dart:convert';

DefaultListModel defaultListModelFromMap(String str) => DefaultListModel.fromMap(json.decode(str));

String defaultListModelToMap(DefaultListModel data) => json.encode(data.toMap());
...
class DefaultListModel {
  ...
  factory DefaultListModel.fromMap(Map<String, dynamic> json) => DefaultListModel(
    terminals: json["terminals"] == null ? [] : List<Terminal>.from(json["terminals"]!.map((x) => Terminal.fromMap(x))),
    commodites: json["commodites"] == null ? [] : List<Commodite>.from(json["commodites"]!.map((x) => Commodite.fromMap(x))),
    employee: json["employee"] == null ? [] : List<Employee>.from(json["employee"]!.map((x) => Employee.fromMap(x))),
    labour: json["labour"] == null ? [] : List<Labour>.from(json["labour"]!.map((x) => Labour.fromMap(x))),
    status: json["status"],
    message: json["message"],
  );

  Map<String, dynamic> toMap() => {
    "terminals": terminals == null ? [] : List<dynamic>.from(terminals!.map((x) => x.toMap())),
    ...
    "labour": labour == null ? [] : List<dynamic>.from(labour!.map((x) => x.toMap())),
    "status": status,
    "message": message,
  };
}
...
class Commodite {
  ...
  bool districtFilterByName(String filter) {
    return this.category.toString().toLowerCase().trim().contains(filter);
  }
...
class Terminal {
  ...
  String? longitude;
  String? pincode;
  DateTime? agrementFromDate;
  DateTime? agrementToDate;
  DateTime? terminalOpenDate;
