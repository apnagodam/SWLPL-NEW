...
//
//     final stackQualityPdfCreatemodal = stackQualityPdfCreatemodalFromJson(jsonString);

import 'dart:convert';

StackQualityPdfCreatemodal stackQualityPdfCreatemodalFromJson(String str) => StackQualityPdfCreatemodal.fromJson(json.decode(str));

String stackQualityPdfCreatemodalToJson(StackQualityPdfCreatemodal data) => json.encode(data.toJson());

class StackQualityPdfCreatemodal {
    dynamic status;
    dynamic message;
    Data? data;

    StackQualityPdfCreatemodal({
        this.status,
        this.message,
        this.data,
    });

    factory StackQualityPdfCreatemodal.fromJson(Map<String, dynamic> json) => StackQualityPdfCreatemodal(
        status: json["status"],
